...
<header class="bg-green-900 text-white px-6 py-4 text-2xl font-bold shadow">
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center flex-wrap">
      <h1 class="text-lg md:text-2xl font-bold">Agrar-Drohnenkarte</h1>
      <span class="hidden md:inline font-light text-xs md:text-sm ml-2">by Feldflieger GmbH</span>
    </div>
    ...
    <div class="hidden md:flex items-center space-x-4">
      ...
      <a href="https://www.instagram.com/feldflieger.eu/" target="_blank" class="hover:text-gray-300">
      ...
      <a href="https://github.com/Feldflieger-GmbH/agrar-drohnenkarte" target="_blank" class="hover:text-gray-300">
        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href="https://feldflieger.eu/kontakt/" target="_blank" class="font-light text-sm hover:underline">
        Kontakt
      </a>
      <a href="https://feldflieger.eu/impressum/" target="_blank" class="font-light text-sm hover:underline">
        Impressum
      </a>
    </div>
  </div>
  ...
  <div v-if="mobileMenuOpen" class="md:hidden mt-4 pt-4 border-t border-blue-800">
    <div class="space-y-2">
      ...
      <div class="flex space-x-4">
        <a href="https://www.instagram.com/feldflieger.eu/" target="_blank">
          <span>Instagram</span>
        </a>
      ...
      <a href="https://feldflieger.eu/impressum/" target="_blank" class="block text-sm hover:underline">
        Impressum
      </a>
    </div>
  </div>
